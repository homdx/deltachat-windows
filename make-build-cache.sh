...
if [ -z "$DISABLECACHE" ] ; \
    ...
    wget --no-check-certificate https://static.rust-lang.org/rustup/dist/i686-pc-windows-gnu/rustup-init.exe ; \
    ...
    cd deltachat-node ; \
    git checkout 07360136fda4c9689bab8383b60025b31d9e3be5 ; \
    cd .. ; \
    git clone --recursive https://github.com/deltachat/deltachat-desktop ; \
    cd deltachat-desktop ; \
    git checkout e27fb6d97235d361fd70efb87e14e2bf1bd708d7 ; \
    cd .. ; \
